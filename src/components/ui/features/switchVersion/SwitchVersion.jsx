            ...
            <div className=" max-w-40 w-full mr-4 relative">
              ...
              >
                ...
                <ul className="flex flex-col gap-3 text-sm ">
                  <li className="flex justify-between relative group items-center cursor-pointer">
                    01Philosophy <FaAngleRight />
                    <ul className="absolute bg-white border-l border-solid border-gray-400 group-hover:opacity-100 opacity-0 -right-[145px] -top-5 shadow-xl h-[200px] rounded-lg px-3 py-5">
                      <li>0101 Philosophy</li>
                    </ul>
                  </li>
